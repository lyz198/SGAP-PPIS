...
class FeedForwardBlock(nn.Module):
    ...
    def __init__(self, d_model, d_ff, dropout=0.3, activation='relu'):
...
class MUSEAttention(nn.Module):
    ...
    def __init__(self, d_model, d_k, d_v, h, dropout=0.3):
        ...
        self.pointfeedforward = FeedForwardBlock(d_model, h * d_v)
    ...
    def forward(self, queries, keys, values, attention_mask=None, attention_weights=None):
        ...
        out3 = self.pointfeedforward(values)
